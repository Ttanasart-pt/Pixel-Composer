...
#region text
	...
	draw_text_line(dialog_x + ui(32), py, ctxt[1], -1, dialog_w - ui(64), true);
	py += _hh + ui(16);
	...
	var bx1 = dialog_x + dialog_w - DIALOG_PAD / bamo - bpad;
	var by1 = dialog_y + dialog_h - DIALOG_PAD / bamo - bpad;
	var bx0 = bx1 - bw;
	var by0 = by1 - bh;
