...
#region base UI
	...
	draw_text(_dialog_x + ui(20), _dialog_y + ui(8), __txt("add_images_title_direcory", "Import directory"));
#endregion
...
#region directory option
	...
	draw_set_text(f_p2, fa_left, fa_center, COLORS._main_text);
	draw_text(_dialog_x + ui(20), dy + dh/2, __txt("Filter"));
	
	var bw = ui(100);
	var bx = _dialog_x + dialog_w - ui(16) - bw;
	dy += dh + ui(8);
