function Node_pSystem_Wiggle(_x, _y, _group = noone) : Node(_x, _y, _group) constructor {
	...
	////- =Position
	newInput( 3, nodeValue_Bool(  "Position",   0 )).setInternalName("pos_use");
	...
	////- =Rotation
	newInput( 7, nodeValue_Bool(  "Rotation",   0 )).setInternalName("rot_use");
	...
	////- =Scale
	newInput(11, nodeValue_Bool(  "Scale",      0 )).setInternalName("sca_use");
	...
	////- =Direction
	newInput(15, nodeValue_Bool(  "Direction",  0 )).setInternalName("dir_use");
