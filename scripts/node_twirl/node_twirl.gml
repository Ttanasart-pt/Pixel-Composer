...
function Node_Twirl(_x, _y, _group = noone) : Node_Processor(_x, _y, _group) constructor {
	...
	newInput(2, nodeValue_Slider( "Strength",   3, [-10, 10, 0.01] )).setHotkey("S").setMappable(11).setPieMenu();
	newInput(3, nodeValue_Float(  "Radius",    16                  )).setHotkey("R").setMappable(12).setPieMenu();
