function Panel_Collections_Setting() : Panel_Linear_Setting() constructor {
	title = __txt("collection_settings", "Collection Settings");
	w = ui(380);
