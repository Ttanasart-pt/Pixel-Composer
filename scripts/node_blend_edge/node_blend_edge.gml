...
function Node_Blend_Edge(_x, _y, _group = noone) : Node_Processor(_x, _y, _group) constructor {
	...
	static drawOverlay = function(hover, active, _x, _y, _s, _mx, _my, _params) { 
		...
		InputDrawOverlay(inputs[1].drawOverlay(w_hoverable, active, _cx, _cy, _s, _mx, _my,  90, _dim[0]/2 ));
		InputDrawOverlay(inputs[6].drawOverlay(w_hoverable, active, _cx, _cy, _s, _mx, _my,   0, _dim[0]/2 ));
		InputDrawOverlay(inputs[7].drawOverlay(w_hoverable, active, _cx, _cy, _s, _mx, _my, -90, _dim[0]/2 ));
