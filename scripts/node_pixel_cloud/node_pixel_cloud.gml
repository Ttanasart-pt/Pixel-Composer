function Node_Pixel_Cloud(_x, _y, _group = noone) : Node_Processor(_x, _y, _group) constructor {
	...
	////- =Color
	newInput( 4, nodeValue_Gradient( "Color over lifetime",  gra_white)).setMappable(9).addShift(10);
	...
	static drawOverlay = function(hover, active, _x, _y, _s, _mx, _my, _params) { 
		...
		drawOverlayInput(inputs[2].drawOverlay(w_hoverable, active, _cx, _cy, _s, _mx, _my, 0, _dim[0] * 4));
