...
function Node_Threshold(_x, _y, _group = noone) : Node_Processor(_x, _y, _group) constructor {
	...
	static drawOverlay = function(hover, active, _x, _y, _s, _mx, _my, _params) { 
		...
		if(_b) drawOverlayInput(inputs[2].drawOverlay(w_hoverable, active, _x, _cy - ui(16), _s, _mx, _my, 0, _dim[0]));
		if(_a) drawOverlayInput(inputs[8].drawOverlay(w_hoverable, active, _x, _cy + ui(16), _s, _mx, _my, 0, _dim[0]));
