function Node_PB_FX_Highlight(_x, _y, _group = noone) : Node_Processor(_x, _y, _group) constructor {
	...
	newInput( 2, nodeValue_Color(  "Color Left",   ca_white ));
	newInput( 3, nodeValue_Color(  "Color Right",  ca_white ));
	newInput( 4, nodeValue_Color(  "Color Top",    ca_white ));
	newInput( 5, nodeValue_Color(  "Color Bottom", ca_white ));
