function Node_Dotted(_x, _y, _group = noone) : Node_Processor(_x, _y, _group) constructor {
	...
	////- =Transform
	newInput(14, nodeValue_Vec2(     "Position", [0,0] )).setHotkey("G").setUnitSimple().setPieMenu();
	newInput( 4, nodeValue_Rotation( "Angle",     0    )).setHotkey("R").setMappable(5).setPieMenu();
