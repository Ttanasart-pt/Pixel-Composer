function Node_Grid_Pentagonal(_x, _y, _group = noone) : Node_Processor(_x, _y, _group) constructor {
	...
	inputs[8] = nodeValue_Enum_Scroll("Render type", self,  0, ["Colored tile", "Height map", "Texture grid"]);
	...
	inputs[16] = nodeValue_Slider_Range("Level", self, [ 0, 1 ]);
	
	inputs[17] = nodeValue_Bool("Use Texture Dimension", self, true);
