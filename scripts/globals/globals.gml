...
#region //// MAIN ////
	...
	globalvar VERSION; VERSION        = 1_21_10_0;
	globalvar SAVE_VERSION; SAVE_VERSION   = 1_21_09_2;
	globalvar VERSION_STRING; VERSION_STRING = "1.21.10.001"; // Display on menu panel, workshop thumbnail  ALSO for automated build name.   // 4 level!!
	...
	globalvar BUILD_NUMBER; BUILD_NUMBER   = 1_21_10_0.01;
