...
#region //// MAIN ////
	...
	globalvar VERSION_STRING; VERSION_STRING = "1.21.10.203"; // Display on menu panel, workshop thumbnail  ALSO for automated build name. // 4 level!!
	...
	globalvar BUILD_NUMBER; BUILD_NUMBER   = 1_21_10_2.03;
