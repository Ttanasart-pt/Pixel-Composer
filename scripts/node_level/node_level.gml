function Node_Level(_x, _y, _group = noone) : Node_Processor(_x, _y, _group) constructor {
	...
	inputs[| 1] = nodeValue_Slider_Range("White in", self, [0, 1]);
	
	inputs[| 2] = nodeValue_Slider_Range("Red in", self, [0, 1]);
	
	inputs[| 3] = nodeValue_Slider_Range("Green in", self, [0, 1]);
	
	inputs[| 4] = nodeValue_Slider_Range("Blue in", self, [0, 1]);
	
	inputs[| 5] = nodeValue_Slider_Range("Alpha in", self, [0, 1]);
	...
	inputs[| 12] = nodeValue_Slider_Range("White out", self, [0, 1]);
	
	inputs[| 13] = nodeValue_Slider_Range("Red out", self, [0, 1]);
	
	inputs[| 14] = nodeValue_Slider_Range("Green out", self, [0, 1]);
	
	inputs[| 15] = nodeValue_Slider_Range("Blue out", self, [0, 1]);
	
	inputs[| 16] = nodeValue_Slider_Range("Alpha out", self, [0, 1]);
