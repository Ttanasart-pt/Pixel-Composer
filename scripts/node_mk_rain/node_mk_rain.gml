function Node_MK_Rain(_x, _y, _group = noone) : Node_Processor(_x, _y, _group) constructor {
	...
	newInput(26, nodeValue_Toggle(   "Tile",       0b01, ["X","Y"] ));
	...
	static drawOverlay = function(hover, active, _x, _y, _s, _mx, _my, _params) { 
		...
		if(_grdUse) {
			...
			drawOverlayInput(inputs[19].drawOverlay(hover, active, _x + _dim[0] / 2 * _s, _y, _s, _mx, _my, -90));
		}
	}
	...
	static processData = function(_outSurf, _data, _array_index) {
		...
		var tileX = bool(_tile & 0b01);
		var tileY = bool(_tile & 0b10);
				...
				switch(_shap) {
					case 0 : 						
						...
						if( _afad && _drpW == 1) {
						   	...
						   	if(tileY) {
							   	draw_line_color( _x0, _y0-_sh, _x1, _y1-_sh, _lcc, c_black );
							   	draw_line_color( _x0, _y0+_sh, _x1, _y1+_sh, _lcc, c_black );
						   	}
						   	
							if(tileX && tileY) {
							   	draw_line_color( _x0-_sw, _y0-_sh, _x1-_sw, _y1-_sh, _lcc, c_black );
							   	draw_line_color( _x0+_sw, _y0-_sh, _x1+_sw, _y1-_sh, _lcc, c_black );
							...
							if(tileY) {
								draw_line_width_color( _x0, _y0-_sh, _x1, _y1-_sh, _drpW, _lcc, c_black ); 
								draw_line_width_color( _x0, _y0+_sh, _x1, _y1+_sh, _drpW, _lcc, c_black ); 
							}
							
							if(tileX && tileY) {
								draw_line_width_color( _x0-_sw, _y0-_sh, _x1-_sw, _y1-_sh, _drpW, _lcc, c_black ); 
								draw_line_width_color( _x0+_sw, _y0-_sh, _x1+_sw, _y1-_sh, _drpW, _lcc, c_black ); 
							...
							if(tileY) {
								draw_line( _x0, _y0-_sh, _x1, _y1-_sh );
								draw_line( _x0, _y0+_sh, _x1, _y1+_sh );
							}
							
							if(tileX && tileY) {
								draw_line( _x0-_sw, _y0-_sh, _x1-_sw, _y1-_sh );
								draw_line( _x0+_sw, _y0-_sh, _x1+_sw, _y1-_sh );
							...
							if(tileY) {
								draw_line_width( _x0, _y0-_sh, _x1, _y1-_sh, _drpW ); 
								draw_line_width( _x0, _y0+_sh, _x1, _y1+_sh, _drpW ); 
							}
							
							if(tileX && tileY) {
								draw_line_width( _x0-_sw, _y0-_sh, _x1-_sw, _y1-_sh, _drpW ); 
								draw_line_width( _x0+_sw, _y0-_sh, _x1+_sw, _y1-_sh, _drpW ); 
					...
					case 1 : 
						...
						if(tileY) {
							draw_circle(_x0, _y0-_sh, _drpW * _scaL, false); 
							draw_circle(_x0, _y0+_sh, _drpW * _scaL, false); 
						}
						
						if(tileX && tileY) {
							draw_circle(_x0-_sw, _y0-_sh, _drpW * _scaL, false); 
							draw_circle(_x0+_sw, _y0-_sh, _drpW * _scaL, false); 
					...
					case 2 : 
						...
						var aa = draw_get_alpha();
						
						draw_surface_ext(_text, xx, yy, _scaL, _scaL, 0, cc, aa); 
						
						if(tileX) {
							draw_surface_ext(_text, xx-_sw, yy, _scaL, _scaL, 0, cc, aa); 
							draw_surface_ext(_text, xx+_sw, yy, _scaL, _scaL, 0, cc, aa); 
						}
						
						if(tileY) {
							draw_surface_ext(_text, xx, yy-_sh, _scaL, _scaL, 0, cc, aa); 
							draw_surface_ext(_text, xx, yy+_sh, _scaL, _scaL, 0, cc, aa); 
						}
						
						if(tileX && tileY) {
							draw_surface_ext(_text, xx-_sw, yy-_sh, _scaL, _scaL, 0, cc, aa); 
							draw_surface_ext(_text, xx+_sw, yy-_sh, _scaL, _scaL, 0, cc, aa);
