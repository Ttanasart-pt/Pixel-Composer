function Panel_Graph_Connection_Setting() : Panel_Linear_Setting() constructor {
	title = __txt("graph_connection_settings", "Connection Settings");
	...
	properties = [
		...
		new __Panel_Linear_Setting_Item(
			__txt("dialog_connection_thickness", "Line thickness"),
		...
		new __Panel_Linear_Setting_Item(
			__txt("dialog_connection_radius", "Corner radius"),
		...
		new __Panel_Linear_Setting_Item(
			__txt("dialog_connection_extends", "Extends"),
		...
		new __Panel_Linear_Setting_Item(
			__txt("pref_connection_quality", "Render quality"),
		...
		new __Panel_Linear_Setting_Item(
			__txt("pref_connection_highlight", "Highlight connection"),
		...
		new __Panel_Linear_Setting_Item(
			__txt("pref_connection_highlight_fade", "Fade connection"),
		...
		new __Panel_Linear_Setting_Item(
			__txt("pref_connection_highlight_all", "Highlight all"),
		...
		new __Panel_Linear_Setting_Item(
			__txt("pref_connection_auto_connect", "Auto Connect"),
