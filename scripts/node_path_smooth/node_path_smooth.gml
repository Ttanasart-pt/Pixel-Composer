	...
	static update = function(frame = CURRENT_FRAME) { #region
		...
		if(amo == 2) { 
			...
			for( var i = 0, n = amo; i < n; i++ ) {
				var _a0 = array_safe_get(anchors, i - 1,, ARRAY_OVERFLOW.loop);
				var _a1 = array_safe_get(anchors, i    ,, ARRAY_OVERFLOW.loop);
				var _a2 = array_safe_get(anchors, i + 1,, ARRAY_OVERFLOW.loop);
