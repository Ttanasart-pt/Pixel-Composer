function Node_Herringbone_Tile(_x, _y, _group = noone) : Node_Processor(_x, _y, _group) constructor {
	...
	inputs[4] = nodeValue_Float("Gap", self, 0.25)
	...
	inputs[17] = nodeValue_Float("Tile length", self, 2);
	...
	inputs[20] = nodeValue_Rotation_Range("Texture angle", self, [ 0, 0 ]);
			
	inputs[21] = nodeValue_Slider_Range("Level", self, [ 0, 1 ]);
