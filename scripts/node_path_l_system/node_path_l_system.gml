...
function Node_Path_L_System(_x, _y, _group = noone) : Node_Processor(_x, _y, _group) constructor {
	...
	array_push(attributeEditors, Node_Attribute("Rule length limit", function() /*=>*/ {return attributes.rule_length_limit}, 
		function() /*=>*/ {return textBox_Number(function(v) /*=>*/ { setAttribute("rule_length_limit", v, true); cache_data.start = ""; })}));
