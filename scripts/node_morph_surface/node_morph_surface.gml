function Node_Morph_Surface(_x, _y, _group = noone) : Node_Processor(_x, _y, _group) constructor {
	...
	////- =Morph
	newInput(2, nodeValue_Slider( "Morph Amount", 0 )).setHotkey("S").setPieMenu();
	newInput(3, nodeValue_Slider( "Threshold",   .1 )).setHotkey("T").setPieMenu();
	// input 4
	...
	static drawOverlay = function(hover, active, _x, _y, _s, _mx, _my, _params) { 
		...
		drawOverlayInput(inputs[3].drawOverlay(w_hoverable, active, _cx, _cy, _s, _mx, _my, 90, _dim[1] / 2));
