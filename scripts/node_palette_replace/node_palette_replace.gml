function Node_Palette_Replace(_x, _y, _group = noone) : Node_Processor(_x, _y, _group) constructor {
	...
	newInput(1, nodeValue_Palette("Palette from", self, array_clone(DEF_PALETTE)));
	
	newInput(2, nodeValue_Palette("Palette to", self, array_clone(DEF_PALETTE)));
	...
	outputs[0] = nodeValue_Output("Surface out", self, VALUE_TYPE.color, [ ] )
