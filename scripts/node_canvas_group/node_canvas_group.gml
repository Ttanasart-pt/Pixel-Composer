function Node_Canvas_Group(_x, _y, _group) : Node_Collection(_x, _y, _group) constructor {
	...
	static drawPreviewToolbar = function(_mx, _my, xx, yy, tool_size, hover, focus, panel) {
		return canvas_sel? canvas_sel.drawPreviewToolbar(_mx, _my, xx, yy, tool_size, hover, focus, panel) : 0;
	}
