...
function Node_Spherize(_x, _y, _group = noone) : Node_Processor(_x, _y, _group) constructor {
	...
	static drawOverlay = function(hover, active, _x, _y, _s, _mx, _my, _params) { 
		...
		drawOverlayInput(inputs[ 2].drawOverlay(w_hoverable, active, px, py, _s, _mx, _my, rot, _dim[0]/2, 2));
		drawOverlayInput(inputs[14].drawOverlay(w_hoverable, active, px, py, _s, _mx, _my));
