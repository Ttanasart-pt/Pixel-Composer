#region
	FN_NODE_TOOL_INVOKE {
		hotkeyCustom("Node_Armature_Mesh_Rig",  "Pose",          "P");
		hotkeyCustom("Node_Armature_Mesh_Rig",  "Weight Brush",  "B");
		hotkeyCustom("Node_Armature_Mesh_Rig",  "Weight Eraser", "E");
	});
#endregion
...
function Node_Armature_Mesh_Rig(_x, _y, _group = noone) : Node(_x, _y, _group) constructor {
	...
	newInput(1, nodeValue_Mesh(    "Mesh", noone )).setVisible(true, true);
