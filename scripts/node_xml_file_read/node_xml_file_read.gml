function Node_create_XML_File_Read(_x, _y, _group = noone) {
	var path = "";
	if(NODE_NEW_MANUAL) {
		path = get_open_filename_compat("XML (.xml)|*.xml", "");
		key_release();
...
function Node_XML_File_Read(_x, _y, _group = noone) : Node(_x, _y, _group) constructor {
	...
	array_push(attributeEditors, Node_Attribute( "File Watcher", function() /*=>*/ {return attributes.file_checker}, 
		function() /*=>*/ {return new checkBox(function() /*=>*/ {return toggleAttribute("file_checker")})} ));
