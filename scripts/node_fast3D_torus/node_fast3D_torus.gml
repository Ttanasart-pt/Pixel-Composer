function Node_Fast3D_Torus(_x, _y, _group = noone) : Node_Fast3D(_x, _y, _group) constructor {
	name = "Fast Torus";
	...
	newInput( fast_i+5, nodeValue_Vec2(   "Radius", [.75,.25] ));
	...
	input_display_list = [
		FAST3D_PRE
		[ "Geometry",  false ], fast_i+2, fast_i+5, 
