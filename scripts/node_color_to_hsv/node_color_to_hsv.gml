function Node_Color_to_HSV(_x, _y, _group = noone) : Node_Processor(_x, _y, _group) constructor {
	...
	newOutput(0, nodeValue_Output("Hue",        self, VALUE_TYPE.float, 0));
	newOutput(1, nodeValue_Output("Saturation", self, VALUE_TYPE.float, 0));
	newOutput(2, nodeValue_Output("Value",      self, VALUE_TYPE.float, 0));
