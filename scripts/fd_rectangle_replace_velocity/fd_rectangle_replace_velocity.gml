...
function fd_rectangle_replace_velocity(domain, sprite_index, image_index, _x, _y, xscale, yscale, xvelo, yvelo) {
	...
	with (domain) {
	    fd_rectangle_set_target(id, FD_TARGET_TYPE.REPLACE_VELOCITY);
	        ...
	        draw_sprite_ext(sprite_index, image_index, _x, _y, xscale, yscale, 0, color, 1);
