function Node_Iterator_Filter_Output(_x, _y, _group = noone) : Node(_x, _y, _group) constructor {
	...
	newInput(0, nodeValue("Value", self, CONNECT_TYPE.input, VALUE_TYPE.any, false ))
		.setVisible(true, true);
	
	newInput(1, nodeValue_Bool("Result", false ))
		.setVisible(true, true);
	...
	static update = function(frame = CURRENT_FRAME) {
		...
		if(global.FLAG.render == 1) LOG($"Value {val} filter result {res} to array {_val}");
