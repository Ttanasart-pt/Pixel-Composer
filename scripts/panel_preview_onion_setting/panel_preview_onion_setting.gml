function Panel_Preview_Onion_Setting() : Panel_Linear_Setting() constructor {
	title = __txt("preview_onion_skin_settings", "Onion skin Settings");
	...
	properties = [
		...
		new __Panel_Linear_Setting_Item(
			__txt("onion_skin_top", "Draw on top"),
		...
		new __Panel_Linear_Setting_Item(
			__txt("onion_skin_frame_range", "Range"),
		...
		new __Panel_Linear_Setting_Item(
			__txt("onion_skin_frame_step", "Frame step"),
		...
		new __Panel_Linear_Setting_Item(
			__txt("onion_skin_pre_color", "Pre Color"),
		...
		new __Panel_Linear_Setting_Item(
			__txt("onion_skin_post_color", "Post Color"),
