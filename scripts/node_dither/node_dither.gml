...
function Node_Dither(_x, _y, _group = noone) : Node_Processor(_x, _y, _group) constructor {
	...
	////- =Pattern
	newInput(22, nodeValue_EScroll( "Map Mode", 0, [ "Positional", "Linear" ] ));
	...
	static processData = function(_outSurf, _data, _array_index) {
		...
		_outSurf = mask_apply_input(_surf, _outSurf, _data[7], _data[8], inputs[7]);
