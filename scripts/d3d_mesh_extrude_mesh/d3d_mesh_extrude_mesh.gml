...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		var _sides = mesh.getSides();
		var vs = [];
	    var vi = 0;
	    
	    for( var j = 0, m = array_length(_sides); j < m; j++ ) {
	    	var br = _sides[j];
	    	...
	    	for( var i = 0; i < n; i++ ) {
	    		...
	    		vs[vi+0] = new __vertex(_p0u * _t, _p0v * _t,  _h).setNormal(n0[0], n0[1], 0).setUV(u0, 0);
				vs[vi+1] = new __vertex(_p0u,      _p0v,      -_h).setNormal(n0[0], n0[1], 0).setUV(u0, 1);
				vs[vi+2] = new __vertex(_p1u * _t, _p1v * _t,  _h).setNormal(n1[0], n1[1], 0).setUV(u1, 0);
				
				vs[vi+3] = new __vertex(_p1u * _t, _p1v * _t,  _h).setNormal(n1[0], n1[1], 0).setUV(u1, 0);
				vs[vi+4] = new __vertex(_p0u,      _p0v,      -_h).setNormal(n0[0], n0[1], 0).setUV(u0, 1);
				vs[vi+5] = new __vertex(_p1u,      _p1v,      -_h).setNormal(n1[0], n1[1], 0).setUV(u1, 1);
				
				edges[eid++] = new __3dObject_Edge(vs[vi+0].toArrayPos(), vs[vi+1].toArrayPos());
				edges[eid++] = new __3dObject_Edge(vs[vi+3].toArrayPos(), vs[vi+5].toArrayPos());
