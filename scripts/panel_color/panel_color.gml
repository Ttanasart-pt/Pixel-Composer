...
function Panel_Color() : PanelContent() constructor {
	...
	function drawContent(panel) {
		...
		if(show_palette) {
			...
			for( var i = 0; i < amo; i++ ) {
				...
				if(i == 0) {
					...
					draw_sprite_stretched_add(THEME.box_r2, 1, cx + ui(4), cy + ui(4), ui(16), ui(16), c_white, 0.3);
				...
				var c  = colors[i - 1];
				var aa = 0.3;
				draw_sprite_stretched_ext(THEME.box_r2, 0, cx, cy, ui(24), ui(24), c, 1);
				...
				draw_sprite_stretched_add(THEME.box_r2, 1, cx, cy, ui(24), ui(24), c_white, aa);
			}
		...
		draw_sprite_stretched_ext(THEME.box_r2, 0, cx - 1, cy - 1, bs + 2, bs + 2, c_black, 0.5);
		draw_sprite_stretched_ext(THEME.box_r2, 0, sx - 1, sy - 1, sw + 2, bs + 2, c_black, 0.5);
		
		draw_sprite_stretched_ext(THEME.box_r2, 0, sx, sy, sw, bs, sc, 1);
		draw_sprite_stretched_ext(THEME.box_r2, 0, cx, cy, bs, bs, cc, 1);
		
		BLEND_ADD
		draw_sprite_stretched_ext(THEME.box_r2, 1, sx, sy, sw, bs, c_white, 0.75);
		draw_sprite_stretched_ext(THEME.box_r2, 1, cx, cy, bs, bs, c_white, 0.75);
		BLEND_NORMAL
