function Node_PB_Draw_Quadrilateral(_x, _y, _group = noone) : Node_PB_Draw(_x, _y, _group) constructor {
	...
	newInput(pbi+0, nodeValue_Vec2( "Top Left",     [0,0] ));
	newInput(pbi+1, nodeValue_Vec2( "Top Right",    [1,0] ));
	newInput(pbi+2, nodeValue_Vec2( "Bottom Left",  [0,1] ));
	newInput(pbi+3, nodeValue_Vec2( "Bottom Right", [1,1] ));
