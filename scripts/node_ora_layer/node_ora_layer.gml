function Node_ORA_layer(_x, _y, _group = noone) : Node(_x, _y, _group) constructor {
	name = "ORA Layer";
	
	newInput(0, nodeValue("Data", self, CONNECT_TYPE.input, VALUE_TYPE.object, noone)).setVisible(false, true).rejectArray();
	...
	static update = function(frame = CURRENT_FRAME) {
		...
		if(!is(content, ORA_File) || layer_object == noone) return;
