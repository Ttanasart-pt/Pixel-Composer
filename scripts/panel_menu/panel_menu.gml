    ...
    #region ++++++++ Menu Items ++++++++
        ...
        menu_help = [ __txt("Help"), [
            ...
            menuItem(__txtx("panel_menu_reset_default", "Reset default collection, assets"),   function() /*=>*/ {
                zip_unzip($"{working_directory}packs/collections.zip", DIRECTORY + "Collections");
                zip_unzip($"{working_directory}packs/assets.zip", DIRECTORY + "Assets");
            }),
            -1,
        ...
        menu_test = [ __txt("Dev"), [
            ...
            menuItemShelf(__txt("Tools"), function(_dat) /*=>*/ {return submenuCall(_dat, [ 
                ...
                -1, 
                menuItem(__txt("Update Theme version"),   function() /*=>*/ {return __test_update_theme()}),
