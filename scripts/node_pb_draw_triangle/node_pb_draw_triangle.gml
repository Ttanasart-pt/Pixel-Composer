function Node_PB_Draw_Triangle(_x, _y, _group = noone) : Node_PB_Draw(_x, _y, _group) constructor {
	...
	newInput(pbi+0, nodeValue_EButton( "Base",        0, array_create(4, s_node_pb_draw_tri_base)  ));
	newInput(pbi+1, nodeValue_Slider(  "Apex Ratio", .5                                            ));
	newInput(pbi+2, nodeValue_EButton( "Mode",        0, array_create(2, s_node_pb_draw_tri_apex)  ));
	newInput(pbi+3, nodeValue_EButton( "Apex Corner", 0, array_create(4, s_node_pb_draw_tri_apexc) ));
