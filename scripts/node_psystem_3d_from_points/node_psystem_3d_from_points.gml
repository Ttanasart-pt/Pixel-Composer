function Node_pSystem_3D_from_Points(_x, _y, _group = noone) : Node(_x, _y, _group) constructor {
	name  = "From Points";
	icon  = THEME.vfx;
	...
	////- =Spawn
	newInput( 0, nodeValue_Vec3( "Points Data", [0,0,0] )).setVisible(true, true).setArrayDepth(1);
	// input
