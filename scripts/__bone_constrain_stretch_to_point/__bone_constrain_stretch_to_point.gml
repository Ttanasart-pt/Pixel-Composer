function __Bone_Constrain_Stretch_To_Point(_bone, _bid = "", _tid = "") : __Bone_Constrain(_bone) constructor {
    name      = "Stretch To Point";
    sindex    = 5;
    bone_id   = _bid;
    bone_object   = noone;
    ...
    static constrain = function(_b) {
        ...
        var _dr = point_distance(_fr.x, _fr.y, point[0], point[1]);
    ...
    static drawInspector = function(_x, _y, _w, _m, _hover, _focus, _drawParam) { 
        ...
        var _dParam = new widgetParam(_wdx, _y, _wdw, _wdh, point, undefined, _m, _drawParam.rx, _drawParam.ry)
            .setFont(f_p3).setScrollpane(_drawParam.panel).setFocusHover(_focus, _hover);
