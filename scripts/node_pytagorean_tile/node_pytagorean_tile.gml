#region
	FN_NODE_CONTEXT_INVOKE {
		addHotkey("Node_Pytagorean_Tile", "Render Type > Toggle", "R", MOD_KEY.none, function() /*=>*/ { PANEL_GRAPH_FOCUS_STR _n.inputs[7].setValue((_n.inputs[7].getValue() + 1) % 3); });
	});
#endregion
...
function Node_Pytagorean_Tile(_x, _y, _group = noone) : Node_Processor(_x, _y, _group) constructor {
	...
	newInput(17, nodeValue_Rotation("Phase", self, 90));
