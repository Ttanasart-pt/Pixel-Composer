function Node_PB_Box_Mirror(_x, _y, _group = noone) : Node_PB_Box(_x, _y, _group) constructor {
	...
	inputs[| 2] = nodeValue("Horizontal", self, JUNCTION_CONNECT.input, VALUE_TYPE.boolean, false );
		
	inputs[| 3] = nodeValue("Vertical", self, JUNCTION_CONNECT.input, VALUE_TYPE.boolean, false );
