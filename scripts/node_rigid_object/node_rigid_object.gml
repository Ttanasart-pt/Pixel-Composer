...
function Node_Rigid_Object(_x, _y, _group = noone) : Node(_x, _y, _group) constructor {
	...
	static drawOverlay = function(hover, active, _x, _y, _s, _mx, _my, _params) { 
		...
		drawOverlayInput(inputs[ 7].drawOverlay(w_hoverable, active, _x, _y, _s, _mx, _my));
		drawOverlayInput(inputs[17].drawOverlay(w_hoverable, active, px, py, _s, _mx, _my));
		...
		for( var i = 0; i < len; i++ ) {
			...
			draw_line_width(_dx0, _dy0, _dx1, _dy1, hover_index == i + 0.5? ui(2) : ui(1));
