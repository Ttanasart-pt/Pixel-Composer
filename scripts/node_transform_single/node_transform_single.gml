function Node_Transform_Single(_x, _y, _group = noone) : Node_Processor(_x, _y, _group) constructor {
	...
	newInput(1, nodeValue_Float("Position x", 0));
	newInput(2, nodeValue_Float("Position y", 0));
	newInput(3, nodeValue_Float("Anchor x", 0));
	newInput(4, nodeValue_Float("Anchor y", 0));
	newInput(5, nodeValue_Float("Rotation", 0));
	newInput(6, nodeValue_Float("Scale x", 1));
	newInput(7, nodeValue_Float("Scale y", 1));
