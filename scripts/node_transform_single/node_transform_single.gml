function Node_create_Transform_Single(_x, _y) {
	var node = new Node_Transform_Single(_x, _y);
	ds_list_add(PANEL_GRAPH.nodes_list, node);
	return node;
}

function Node_Transform_Single(_x, _y) : Node_Processor(_x, _y) constructor {
