function Node_DLL(_x, _y, _group = noone) : Node(_x, _y, _group) constructor {
	...
	newInput(0, nodeValue_FPath("DLL File"))
	...
	array_adjust_tool = new Inspector_Custom_Renderer(function(_x, _y, _w, _m, _hover, _focus) {
		...
		if(buttonTextIconInstant(attributes.size > 0, THEME.button_hide_fill, _x + _w - bw, _y + ui(8), bw, bh, _m, _hover, _focus, "", THEME.minus, __txt("Remove"), COLORS._main_value_negative) == 2) {
			attributes.size--;
			refreshDynamicInput();
			triggerRender();
		}
