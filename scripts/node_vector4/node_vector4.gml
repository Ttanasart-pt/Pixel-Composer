function Node_Vector4(_x, _y, _group = noone) : Node_Processor(_x, _y, _group) constructor {
	...
	newInput(3, nodeValue_Float("w", 0)).setVisible(true, true);
	newInput(4, nodeValue_Bool("Integer", false));
	
	////////////////////////////////////////////////////////////////////////////////////////////////////
	
	newOutput(0, nodeValue_Output("Vector", VALUE_TYPE.float, [ 0, 0, 0, 0 ])).setDisplay(VALUE_DISPLAY.vector);
