function Node_Vector_Cross_3D(_x, _y, _group = noone) : Node_Processor(_x, _y, _group) constructor {
	...
	newInput( 0, nodeValue_Vec3( "Point 1", [0,0,0] )).setVisible(true, true);
	newInput( 1, nodeValue_Vec3( "Point 2", [0,0,0] )).setVisible(true, true);
		
	newOutput(0, nodeValue_Output("Result", VALUE_TYPE.float, [0,0,0] )).setDisplay(VALUE_DISPLAY.vector);
