function Node_PB_Dimension(_x, _y, _group = noone) : Node(_x, _y, _group) constructor {
	...
	newOutput( 0, nodeValue_Output( "Dimension", VALUE_TYPE.float, [1,1] )).setDisplay(VALUE_DISPLAY.vector);
	newOutput( 1, nodeValue_Output( "Width",     VALUE_TYPE.float,  1    )).setVisible(false)
