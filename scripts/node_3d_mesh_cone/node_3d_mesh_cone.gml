function Node_3D_Mesh_Cone(_x, _y, _group = noone) : Node_3D_Mesh(_x, _y, _group) constructor {
	...
	newInput(in_mesh + 0, nodeValue_Int("Side", 8 ))
		.setValidator(VV_min(3));
	
	newInput(in_mesh + 1, nodeValue_D3Material("Material Bottom", new __d3dMaterial()))
		.setVisible(true, true);
	
	newInput(in_mesh + 2, nodeValue_D3Material("Material Side", new __d3dMaterial()))
		.setVisible(true, true);
	
	newInput(in_mesh + 3, nodeValue_Bool("Smooth Side", false ));
