...
if (!display_capture_init_raw()) show_debug_message("Desktop Screenshots DLL failed to load.");

globalvar display_capture_rect_x; display_capture_rect_x = 0;
globalvar display_capture_rect_y; display_capture_rect_y = 0;
globalvar display_capture_rect_w; display_capture_rect_w = display_get_width();
globalvar display_capture_rect_h; display_capture_rect_h = display_get_height();

#define display_capture_measure
/// ()->success?
var l_buf = global.display_capture_mb;
if (!display_capture_measure_raw(buffer_get_address(l_buf))) return false;

display_capture_rect_x = buffer_peek(l_buf,  0, buffer_s32);
display_capture_rect_y = buffer_peek(l_buf,  4, buffer_s32);
display_capture_rect_w = buffer_peek(l_buf,  8, buffer_s32);
display_capture_rect_h = buffer_peek(l_buf, 12, buffer_s32);
return true;
...
var l_est = display_capture_rect_w * display_capture_rect_h * 4;
var l_buf = argument0;
...
var l_sw = display_capture_rect_w, l_sh = display_capture_rect_h;
